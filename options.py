...
class Option(argparse.Namespace):
    ...
    load_original_nns: Optional[str]
    save_infer_dir: str
    zoom: bool
    # dynamic
...
def get_options(args: Optional[List[str]] = None) -> Option:
    ...
    parser.add_argument(
        ...
        help='nns actor graph embedding type',
    )
    parser.add_argument(
        '--embed_type_sc',
        default='pair',
    ...
    parser.add_argument(
        ...
        help='NNS NodePairRemovalDecoder type',
    )
    parser.add_argument(
        '--warm_up_type',
        default='origin',  # variable default
        choices=('origin', 'update'),
        help='NNS curriculum learning type',
    )
    parser.add_argument('--load_original_nns', help='path to load original NNS actor')
    parser.add_argument(
    ...
    parser.add_argument(
        '--actor_head_num', type=int, default=4, help='head number of NNS actor'
    )
    parser.add_argument(
        '--critic_head_num', type=int, default=4, help='head number of NNS critic'
    )
    parser.add_argument(
        '--embedding_dim',
        type=int,
    ...
    if opts.embed_type_nns == 'share' and opts.embed_type_sc == 'share':
        opts.embed_type_nns = 'together'
